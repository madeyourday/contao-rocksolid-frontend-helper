...
class BackendHooks
{
     ...
     */
    public function initializeSystemHook(): void
    {
        if (
            !Input::get('rsfhr')
        ...
        if ('create' === Input::get('act') && Input::get('id')) {
     ...
     */
    public function loadDataContainerHook($table): void
    {
     ...
     * @param string $ref
     */
    private function removeRsfhrParam($ref): void
    {
     ...
     * Preselects the original template in the template editor.
     */
    private function handleTemplateSelection(): void
    {
        if ('new_tpl' !== Input::get('key')) {
            return;
        }
     ...
     * Saves the referrer in the session if it is a frontend URL.
     */
    private function storeFrontendReferrer(): void
    {
